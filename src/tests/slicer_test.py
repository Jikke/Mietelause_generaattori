...
class TestSclicer(unittest.TestCase):
    def setUp(self):
        self._slicer = Slicer()
        self._files = Files(os.path.join(os.path.expanduser(
    ...
    def test_slice_to_raw_lines_works(self):
        ...
        self.assertEqual(
            lines[0], '1. "If you want to achieve greatness stop asking for permission." --Anonymous\n')
    ...
    def test_slice_specials_works(self):
        ...
        self.assertEqual(
            clean_list[0], 'If you want to achieve greatness stop asking for permission.')
